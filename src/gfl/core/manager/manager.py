...
from gfl.core.scheduler.job_manager import JobManager
from gfl.core.scheduler.scheduler import JobAggregateScheduler, JobTrainScheduler
    ...
    def run_old(self):
        while True:
            ...
            while self.waiting_list:
                ...
                temp_topology_manager = Lfs.load_topology_manager(selected_job.job_id)
