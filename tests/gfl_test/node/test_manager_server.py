...
from gfl.core.manager.node import NodeManager
from gfl.topology import CentralizedTopologyManager
from tests.gfl_test.job.generate_job import generate_job
...
if __name__ == '__main__':
    ...
    # self.node_manager_client1 = NodeManager(manager=node_client1, role="client")
    # self.node_manager_client2 = NodeManager(manager=node_client2, role="client")
    # 创建job
    job = generate_job()
